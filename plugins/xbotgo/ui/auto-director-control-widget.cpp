...
AutoDirectorControlWidget::AutoDirectorControlWidget(AutoDirector &director, const QString &title,
	...
	: QWidget(parent)
{
	...
	cooldown->setRange(AutoDirector::MinimumSwitchCooldownSeconds, AutoDirector::MaximumSwitchCooldownSeconds);
